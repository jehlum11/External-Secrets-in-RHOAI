...
Declare what you need via an ExternalSecret resource.
ESO Syncs the data from an external secret store (we use Vault in this example) into a standard Kubernetes Secret.
Consume that Secret in your Notebooks, Pipelines etc.
